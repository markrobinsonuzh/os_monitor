...
Filters can be applied to subset the data in the box on the left hand side with the title `Filter options`. 
...
in Publons at the same time. The Upset plot underneath the filter box shows a 
