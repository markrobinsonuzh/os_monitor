...
author <- c("schaepman m 0000 0002 9627 9565 schäpman", "schaepman m e schäpman")
orcid <- "0000-0002-9627-9565"
...
ggplot(tbl_author %>% filter(date >= 2005, date <= 2020), aes(x=date, fill=oa_status)) + 
  geom_bar() + 
